...
- [ ] **Phase 10b** — [10b_sound_priority_spell_voices.md](10b_sound_priority_spell_voices.md): Zauberformel der Schamanin beim Cast-Beginn + Effektsound beim Einschlag (Cast-Zeit 1,0 s), Sound-Prioritätensystem (1 Zauberformeln/Schamanentod, 2 Fahrzeug-/Zeppelintode, 3 Rest) inkl. Behebung des Slot-Verwurf-Bugs im AudioManager
