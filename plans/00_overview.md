...
- [ ] **Phase 7b** — [07b_unit_control_behavior.md](07b_unit_control_behavior.md): Steuerung & Einheitenverhalten (Move/Attack-Split + Hotkeys, Fliehen, Brave-Idle-Aggro, Idle-6er-Gruppen, Warteschlangen, Anti-Stacking, Doppelklick-Selektion)
