...
- [ ] **Phase 8.1** — Performance-Neuanlauf: Zuerst die Phase-8-Wegfindungs-Regression verstehen (Hypothese in PROGRESS.md: Pfad-Queue-Zeitbudget → globaler Rückstau, „Laufanimation ohne Bewegung"; zweiter Kandidat Unreachable-Holz-Cache), dann die Phase-8-Optimierungen einzeln und mit Langzeittests abgesichert wieder einführen. **Nutzer-Vorgabe: akkurate 30-Hz-Berechnung — keine Reduktion der Sim-Frequenz.** Der alte 20-Hz-Plan [08a_sim_20hz_interpolation.md](08a_sim_20hz_interpolation.md) ist **verworfen**.
