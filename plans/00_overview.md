...
- [ ] **Phase 8.d** — [08d_perf_soa_stufe_c.md](08d_perf_soa_stufe_c.md): **Kampf-Performance Stufe C (data-oriented / SoA)** — Ziel Debugschlacht ≥ 30 FPS. Engpass gemessen = CPU-units-Phase, ATTACK-dominiert (~1150 × ~10 µs = 11–13 ms/Tick). *(2026-07-20: **Leichen-Early-out umgesetzt** (combat units-Phase −24/−25 %, ~+2 FPS); Chase-A\*-Async / Sub-Tick-Guards / ATTACK-Drossel / Render-Slicing **gemessen & verworfen**. Plan für den strukturellen Umbau (Arrays autoritativ + Doppelschreiben, kein Snapshot — Lehre aus 08b; C1 Fundament+Separation/Hash ~4–5 ms, C2 Kampf-Kernel = eigentliche Masse) steht; Umsetzung offen, Nutzer-Entscheid.)*
