...
- [ ] **Bugfix-Backlog** — [bugs_backlog.md](bugs_backlog.md): offene Bugs aus Nutzertests (UI-Skalierung 1080p/1440p + Auflösungs-Option, unfertige Gebäude durch Einheiten zerstörbar, Holzsuche nach Laufweg statt Luftlinie) *(gesammelt 2026-07-13; Behebung vor/zu Beginn von Phase 9)*
